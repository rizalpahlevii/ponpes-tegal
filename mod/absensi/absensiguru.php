				                            ...
				                            <form class="form-horizontal" role="form" method='POST' action='<?php echo $act ?>'>
				                            	...
				                            	<div class="form-group">
			                                  	...
			                                  	<div class="form-group">
			                                      	...
			                                      	<div class="col-lg-10">
			                                          	<select name="idpelajaran" id="pelajaran" class="form-control round-input" onchange="pilih_pelajaran(this.value);">
			                                  	...
			                                  	<div class="form-group">
			                                      	...
			                                      	<div class="col-lg-10">
			                                          	<select name="idguru" id="guru" class="form-control round-input">
			                                  	...
			                                  	<div class="form-group">
					                                ...
					                                <div class="col-sm-10">
					                                	<input type="text" name="mulai" class="form-control round-input time" value="<?php echo isset($c['mulai']) ? $c['mulai'] : '' ;?>" required>
					                                </div>
					                            </div>
					                            <div class="form-group">
					                                <label class="col-sm-2 control-label">Selesai Pelajaran</label>
					                                <div class="col-sm-10">
					                                	<input type="text" name="selesai" class="form-control round-input time1" value="<?php echo isset($c['selesai']) ? $c['selesai'] : '' ;?>" required>
					                                </div>
					                            </div>
					                            <div class="form-group">
			                                      	<label class="col-lg-2 col-sm-2 control-label">Kehadiran</label>
			                                      	<div class="col-lg-10">
			                                          	<select name="kehadiran" class="form-control round-input">
		        ...
		        <div class="row">
		            ...
		            <div class="col-sm-12">
                        ...
                        <?php if($_SESSION['level']=='admin'){?>
                        	<a href="med.php?mod=absensiguru&act=form">
							<button class="btn btn-primary">
								Tambah <i class="fa fa-plus"></i>
							</button>
							</a>

							<a href="med.php?mod=absensiguru&act=laporan">
				                    ...
				                    <div class="panel-body">
										<div class="table-responsive">											
					                        <table class="table table-striped table-hover table-bordered table-condensed cf">
												...
												<tbody>
													<?php
														$query = "SELECT a.`id`,b.`nama` as pelajaran, c.`rpp` as materi, e.`nama` as guru, a.`mulai`, a.`selesai`, a.`date`, f.`kehadiran`
															FROM `absensi_guru` as a
															JOIN `pelajaran` as b ON a.`idpelajaran` = b.`id`
															JOIN `rpp` as c ON a.`idrpp` = c.`id`
					                                ...
					                                <tr class="">
					                                    ...
					                                    <td align="center"><?php echo $m['materi']?></td>
	                ...
	                <div class="panel-body">
	                    <div class="tab-content">
	                        <div id="home" class="tab-pane active">                            
					            ...
					            <form class="form-horizontal" role="form" method='POST' action='med.php?mod=absensiguru&act=laporandetail'>
						            <div class="col-lg-12">
					                    <div class="panel-body">
					                        <div class="position-center">
					                            <input type="hidden" name="id" value="<?php echo isset($c['id']) ? $c['id'] : '' ;?>">
					                            <div class="form-group">
				                                  <label class="col-lg-2 col-sm-2 control-label">Kelas</label>
				                                  <div class="col-lg-10">
				                                      <select name="idkls" class="form-control">
	                        ...
	                        <div id="about" class="tab-pane">
		                        <form class="form-horizontal" role="form" method='POST' action='med.php?mod=absensiguru&act=laporandetailguru'>
						            <div class="col-lg-12">
					                    <div class="panel-body">
					                        <div class="position-center">
					                            <input type="hidden" name="id" value="<?php echo isset($c['id']) ? $c['id'] : '' ;?>">
					                            <div class="form-group">
				                                  ...
				                                  <div class="col-lg-10">
				                                      <select name="idkls" class="populate" id="e2" style="width: 500px">
	                    ...
	                    <div class="panel-body">
							<div class="table-responsive">											
		                        <table class="table table-striped table-hover table-bordered table-condensed cf">
									...
									<tbody>
										<?php
											$query = "SELECT a.`id`,b.`nama` as pelajaran, c.`rpp` as materi, e.`nama` as guru, a.`mulai`, a.`selesai`, a.`date`, f.`kehadiran`, g.`kelas`
												FROM `absensi_guru` as a
												JOIN `pelajaran` as b ON a.`idpelajaran` = b.`id`
												JOIN `rpp` as c ON a.`idrpp` = c.`id`
												JOIN `guru` as d ON a.`idguru` = d.`id`
