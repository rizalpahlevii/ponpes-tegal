<?php
	...
	if(isset($_SESSION['aspekpenilaian']) AND $_SESSION['aspekpenilaian'] <> 'TRUE')
	{
		?>
	...
	//link buat paging
	$linkaksi = 'med.php?mod=aspekpenilaian';
	...
	$aksi = 'mod/nilai/act_aspekpenilaian.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=aspekpenilaian&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM dasarpenilaian WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=aspekpenilaian");
				}

			}
			else
			{
				$act = "$aksi?mod=aspekpenilaian&act=simpan";
			}
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" name="dasarpenilaian" class="form-control round-input" value="<?php echo isset($c['dasarpenilaian']) ? $c['dasarpenilaian'] : '' ;?>" required>
				                                </div>
				                            </div>
				                            <div class="form-group">
				                                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Aspek Penilaian</label>
				                                <div class="col-lg-10">
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=aspekpenilaian&act=form">
		                    ...
		                    <div class="panel-body table-responsive">
		                        ...
		                        <div class="adv-table editable-table ">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT * FROM dasarpenilaian ORDER BY posisi";
		                                ...
		                                <tr class="">
		                                    ...
		                                    <td align="center"><?php echo $m['dasarpenilaian']?></td>
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=aspekpenilaian&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=aspekpenilaian&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
