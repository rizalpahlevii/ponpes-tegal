<?php
	...
	if(!isset($_SESSION['login_user'])){
		...
		$kelas = $_POST['idkelas'];
		$sm = $_POST['idsemester'];
		$aturan = $_POST['idaturan'];
		$nipguru = $_POST['nipguru'];
			
		flash('example_message', 'Berhasil menambah data nilai.' );
		
		header("location:../../med.php?mod=nilai&aks=nilai&act=form&act=add&act=form&idkelas=$kelas&nipguru=$nipguru&idsemester=$sm&idaturan=$aturan");
