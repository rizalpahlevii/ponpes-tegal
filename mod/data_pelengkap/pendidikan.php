<?php
	...
	if(isset($_SESSION['pendidikan']) AND $_SESSION['pendidikan'] <> 'TRUE')
	{
		?>
	...
	//link buat paging
	$linkaksi = 'med.php?mod=pendidikan';
	...
	$aksi = 'mod/data_pelengkap/act_pendidikan.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=pendidikan&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM tingkatpendidikan WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=pendidikan");
				}

			}
			else
			{
				$act = "$aksi?mod=pendidikan&act=simpan";
			}
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" name="pendidikan" class="form-control round-input" value="<?php echo isset($c['pendidikan']) ? $c['pendidikan'] : '' ;?>" required>
				                                </div>
				                            </div>
				                            <div class="form-group">
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=pendidikan&act=form">
		                    ...
		                    <div class="panel-body">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT * FROM tingkatpendidikan order by urutan asc";
		                                ...
		                                <tr class="">
		                                    ...
		                                    <td align="center"><?php echo $m['pendidikan']?></td>
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=pendidikan&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=pendidikan&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
