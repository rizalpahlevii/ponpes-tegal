				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-6">
				                                    <select class="form-control round-input" name="bagian" style="width: 540px" id="source">
			                                ...
			                                <div class="form-group">
				                                ...
				                                <div class="col-lg-6">
				                                    <select class="form-control round-input" name="nikah" style="width: 540px" id="source">
