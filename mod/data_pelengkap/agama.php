<?php
	...
	if(isset($_SESSION['agama']) AND $_SESSION['agama'] <> 'TRUE')
	{
		?>
	...
	$aksi = 'mod/data_pelengkap/act_agama.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=agama&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM agama WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=agama");
				}

			}
			else
			{
				$act = "$aksi?mod=agama&act=simpan";
			}
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" name="agama" class="form-control round-input" value="<?php echo isset($c['agama']) ? $c['agama'] : '' ;?>" required>
				                                </div>
				                            </div>
				                            <div class="form-group">
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=agama&act=form">
		                    ...
		                    <div class="panel-body">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT * FROM agama order by urutan asc";
		                                ...
		                                <tr class="">
		                                    ...
		                                    <td align="center"><?php echo $m['agama']?></td>
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=agama&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=agama&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
