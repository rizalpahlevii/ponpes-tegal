<?php
	...
	if(isset($_SESSION['jenispembayaran']) AND $_SESSION['jenispembayaran'] <> 'TRUE')
	{
		?>
	...
	//link buat paging
	$linkaksi = 'med.php?mod=jenispembayaran';
	...
	$aksi = 'mod/keuangan/act_jenispembayaran.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=jenispembayaran&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM jenispembayaran WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=jenispembayaran");
				}

			}
			else
			{
				$act = "$aksi?mod=jenispembayaran&act=simpan";
			}
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=jenispembayaran&act=form">
		                    ...
		                    <div class="panel-body">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT * FROM jenispembayaran order by jenis asc";
		                                ...
		                                <tr class="">
		                                    ...
		                                    <td align="center"><?php echo $m['jenis']?></td>
		                                    <td align="center"><?php echo $m['pembayaran']?></td>
		                                   ...
		                                   --> 
		                                        <a href="med.php?mod=jenispembayaran&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=jenispembayaran&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
