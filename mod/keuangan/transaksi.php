			                            ...
			                            <table class="table table-striped">
			                            	...
			                            	<?php
												$query = "SELECT a.*
														 ...
														 LEFT JOIN `detail_transaksi_tmp` as b ON a.id = b.`idpembayaran` 
														 WHERE b.id IS NULL AND `idjenispembayaran` = '$jp[id]'";
												$sql_kul = mysqli_query($conn,$query);	
												$x=1;
												while ($m = mysqli_fetch_assoc($sql_kul)) {
											?>
			                                <tr>
			                                	<form method="POST" action="<?php echo $aksi ?>?mod=transaksi&act=add">
			                                    <td><?php echo $x ?></td>
				                        	...
				                        	<div class="table-responsive">
				                        		<table class="table table-striped table-hover table-bordered">
														...
														$sql_tmp = mysqli_query($conn,"SELECT a.id, a.harga, b.nama
																				...
																				WHERE a.idpembayaran = b.id AND b.`idjenispembayaran` = '$jp[id]' 
														...
														?>
															<tr>
																...
																<td  align="center">
																<a href="<?php echo $aksi ?>?mod=transaksi&act=batal&id=<?php echo $b['id'] ?>" onclick="return confirm('Yakin ingin membatalkan?');"><i class="fa fa-times text-danger"></i></a>
																</td>
															</tr>
														<?php
															$no++;
										                ...
										                <tfoot>
										                	<tr>		                		
											                	...
											                	<?php
											                	$qttl = mysqli_query($conn,"SELECT sum(`harga`)as total FROM `detail_transaksi_tmp`");
											                	$ttl = mysqli_fetch_assoc($qttl);
											                	?>
											                	<td colspan="2" align="right"><b class="text-danger">Rp. <?php echo number_format($ttl['total']) ?></b></td>
											                	<input type='hidden' name='angsuran_pokok' style="text-align:right;" value="<?php echo $ttl['total'] ?>"  size='23'   onFocus="startCalc();" onBlur="stopCalc();" />
										                	</tr>
										                	<tr>
										                	...
										                	<tr class="bg-danger">		                		
											                	...
											                	<td colspan="3"><input type=text value='<?php echo $ttl['total'] ?>' name="total" class='form-control' onchange='tryNumberFormat(this.form.thirdBox);' style="text-align:right;" readonly></td>
										                	</tr>
										                </tfoot>
				                        		</table>
						                        <script>
									            ...
									            -->
													...
													<input type='hidden' name='nis' value='nama - <?php echo $_GET['nis'] ?>'>
									                <div class="form-group">
			                ...
			                <div class="panel-body">
								...
								<div class="box-body no-padding table-responsive">
					              <table class="table table-condensed">
									...
									<tr style='border-bottom:1px dashed #ccc;'>
										<td>Nama / Kelas</td>
										<td>:</td>
										<td><b><?php echo $psn['nis']?> - <?php echo $psn['nama']?> / <?php echo  $psn['kelas'] ?></b></td>
									</tr>

									<tr style='border-bottom:1px dashed #ccc;'>
										<td>Tanggal Transaksi</td>
										<td>:</td>
										<td><b><?php echo tglindo($tra['timestmp']) ?></b></td>
									</tr>
					            ...
					            <div class="box-body">
						          ...
						          <p>
									...
									<a href='med.php?mod=transaksi' class='btn btn-info btn-sm'><i class='fa fa-cart-plus'></i> Transaksi Baru</a>
									<?php } ?>
								...
								<div class="p-3 mb-2 bg-info text-white">
					              ...
					              <div class="box-body" >
					                <div class="form-group">
					                  ...
					                  <input type="text" class="form-control" size="100" value="<?php echo $nama ?>" Disabled>
