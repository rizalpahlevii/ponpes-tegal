<?php
	...
	if(isset($_SESSION['rak_buku']) AND $_SESSION['rak_buku'] <> 'TRUE')
	{
		?>
	...
	$aksi = 'mod/perpustakaan/act_rak_buku.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=rak_buku&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM rak WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=rak_buku");
				}

			}
			else
			{
				$act = "$aksi?mod=rak_buku&act=simpan";
			}
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=rak_buku&act=form">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tr class="">
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=rak_buku&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=rak_buku&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
