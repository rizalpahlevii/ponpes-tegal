						...
						<div class="position-center">
							<form class="form-horizontal" role="form" method='POST' action='<?php echo $act ?>'>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="password" name="password" class="form-control round-input" value="<?php echo isset($c['password']) ? $c['password'] : ''; ?>" required>
									</div>
								</div>
								<div class="form-group">
									<label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Repeat Password</label>
									<div class="col-lg-10">
										<input type="password" name="rpassword" class="form-control round-input" value="<?php echo isset($c['password']) ? $c['password'] : ''; ?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<select name="level" class="form-control round-input" style="width: 550px">
						...
						<div class="panel-body">
							...
							<div class="adv-table editable-table ">
								...
								<table class="table table-striped table-hover table-bordered" id="example">
									...
									<tbody>
										<?php
										$query = "SELECT a.`id`, b.`nip`, b.`nama`, a.`username`, a.`password`, a.`level`, a.`last_login`
												FROM `user` as a
												JOIN `pegawai` as b on a.id_user = b.nip";
