...
?>
	...
	switch ($act) {
		case 'form':
			if (!empty($_GET['id'])) {
				...
				$kodeNIS = $datan['kodeTerbesar'];

				// mengambil angka dari kode barang terbesar, menggunakan fungsi substr
				// dan diubah ke integer dengan (int)
				$urutan = (int) substr($kodeNIS, 4, 4);
				...
				$kodeNIS = $huruf . sprintf("%04s", $urutan);
	...
	?>
						...
						<section class="panel panel-danger">
							...
							<div class="panel-body">
								<div class="position-center">
									...
									<?php
									if ($_SESSION['level'] == 'admin' or $_SESSION['level'] == 'keuangan madrasah' or $_SESSION['level'] == 'pendaftaran') {
									?>
									...
									?>
										<input type="hidden" name="idkelas" class="form-control round-input" value="<?php echo isset($c['idkelas']) ? $c['idkelas'] : ''; ?>">
									<?php
									}
									?>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select name="idangkatan" class="form-control round-input" style="width: 100%">
												<?php
												$sql_angkatan = mysqli_query($conn, "SELECT * FROM tahunajaran WHERE aktif='Aktif'");
									...
									<!--
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" name="nis" class="form-control round-input" value="<?php echo isset($c['nis']) ? $c['nis'] : $kodeNIS; ?>" >
				                                </div>
				                            </div>
				                            <div class="form-group">
									...
									<!--<div class="form-group">
		                                      <label class="col-lg-2 col-sm-2 control-label">Agama</label>
		                                      	<div class="col-lg-6">
		                                          	<select  name="agama" class="form-control round-input" style="width: 100%">
		                                              <?php
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select name="kondisi" class="form-control round-input" style="width: 100%">
												<?php
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select class="form-control round-input" name="warga" style="width: 100%" id="source">
							...
							<div class="panel-body">
								<div class="position-center">
									<div class="form-group">
										...
										<div class="col-lg-6">
											<select class="form-control round-input" name="darah" style="width: 100%" id="source">
							...
							<div class="panel-body">
								<div class="position-center">
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<select name="pendidikanayah" class="form-control round-input" style="width: 100%">
												<?php
										...
										<div class="col-lg-5">
											<select name="pendidikanibu" class="form-control round-input" style="width: 100%">
												<?php
												$sql_kondisi = mysqli_query($conn, "SELECT * FROM tingkatpendidikan order by urutan");
												while ($k = mysqli_fetch_assoc($sql_kondisi)) {
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<select name="pekerjaanayah" class="form-control round-input" style="width: 100%">
												<?php
										...
										<div class="col-lg-5">
											<select name="pekerjaanibu" class="form-control round-input" style="width: 100%">
												<?php
												$sql_kondisi = mysqli_query($conn, "SELECT * FROM jenispekerjaan order by urutan");
												while ($k = mysqli_fetch_assoc($sql_kondisi)) {
							...
							<div class="panel-body">
								<div class="position-center">
									...
									<?php if ($_SESSION['level'] == 'admin' or $_SESSION['level'] == 'ortu'  or $_SESSION['level'] == 'siswa') { ?>
										<div class="form-group">
		...
		?>
			...
			<div class="row">
				...
				<div class="clearfix">
					...
					<div class="col-sm-12">
						<section class="panel">
							<header class="panel-heading">
								<?php if ($_SESSION['level'] == 'admin' or $_SESSION['level'] == 'keuangan mahad' or $_SESSION['level'] == 'pendaftaran') { ?>
								...
								<!--<?php if ($_SESSION['level'] == 'admin') { ?>
		                        	<a href="<?php echo $linkaksi ?>&act=formimport">
									<button class="btn btn-primary">
										...
										<table class="table table-striped table-hover table-bordered" id="example">
											<thead>
												<tr>
													...
													<?php if ($_SESSION['level'] == 'absensi sp' or $_SESSION['level'] == 'admin' or $_SESSION['level'] == 'absensi ibt' or $_SESSION['level'] == 'absensi ts' or $_SESSION['level'] == 'absensi aly' or $_SESSION['level'] == 'absensi sorogan' or $_SESSION['level'] == 'pendaftaran') {
													?>
														<th class="text-center">Status</th>
													<?php
													} ?>
													<?php if ($_SESSION['level'] == 'admin' or $_SESSION['level'] == 'keuangan mahad' or $_SESSION['level'] == 'keuangan madrasah' or $_SESSION['level'] == 'pendaftaran' or $_SESSION['level'] == 'absensi ibt' or $_SESSION['level'] == 'absensi ts' or $_SESSION['level'] == 'absensi sp' or $_SESSION['level'] == 'absensi aly') { ?>
											...
											<tbody>
												...
												if ($_SESSION['level'] == 'absensi ibt') {
													...
													$kls = $subk;
													$kls1 = $subk1;
													$query = "SELECT nis,nama,asalsekolah,tmplahir,tgllahir,DAY(tgllahir) as tgl,MONTH(tgllahir) as bln,YEAR(tgllahir) as thn,s.id,s.statusmutasi,s.alumni,s.nisn , k.kelas, s.alamatsiswa
														FROM siswa as s 
                                                        left join kelas k on s.idkelas = k.id
                                                        left join tahunajaran t on t.id = k.idtahunajaran
                                                        where s.alumni=0 AND k.`kelas` = '$kls1 IBT $kls' AND k.`tingkat` BETWEEN 3 AND 6 ORDER BY nis DESC";
													...
													$query = "SELECT nis,nama,asalsekolah,tmplahir,tgllahir,DAY(tgllahir) as tgl,MONTH(tgllahir) as bln,YEAR(tgllahir) as thn,s.id,s.statusmutasi,s.alumni,s.nisn , k.kelas, s.alamatsiswa
                                                        ...
                                                        left join kelas k on s.idkelas = k.id
                                                        left join tahunajaran t on t.id = k.idtahunajaran
                                                        where s.alumni=0 AND k.`kelas` = '$kls1 TS $kls' AND k.`tingkat` BETWEEN 7 AND 9 ORDER BY nis DESC";
													...
													$query = "SELECT nis,nama,asalsekolah,tmplahir,tgllahir,DAY(tgllahir) as tgl,MONTH(tgllahir) as bln,YEAR(tgllahir) as thn,s.id,s.statusmutasi,s.alumni,s.nisn , k.kelas, s.alamatsiswa
                                                        ...
                                                        left join kelas k on s.idkelas = k.id
                                                        left join tahunajaran t on t.id = k.idtahunajaran
                                                        where s.alumni=0 AND k.`kelas` = '$kls1 ALY $kls' AND k.`tingkat` BETWEEN 10 AND 12 ORDER BY nis DESC";
												} elseif ($_SESSION['level'] == 'absensi sp') {
													$subk = substr($_SESSION['login_user'], 2);
													$kls = $subk;
													echo "<script>console.log('Debug Objects: " . $subk . "' );</script>";
													//echo $subk ;
													$query = "SELECT nis,nama,asalsekolah,tmplahir,tgllahir,DAY(tgllahir) as tgl,MONTH(tgllahir) as bln,YEAR(tgllahir) as thn,s.id,s.statusmutasi,s.alumni,s.nisn , k.kelas, s.alamatsiswa
														FROM siswa as s 
                                                        left join kelas k on s.idkelas = k.id
                                                        left join tahunajaran t on t.id = k.idtahunajaran
                                                        where s.alumni=0 AND k.`kelas` = 'SP $kls' AND k.`tingkat` ='2' ORDER BY nis DESC";
												} elseif ($_SESSION['level'] == 'pendaftaran') {
													$query = "SELECT nis,nama,asalsekolah,tmplahir,tgllahir,DAY(tgllahir) as tgl,MONTH(tgllahir) as bln,YEAR(tgllahir) as thn,s.id,s.statusmutasi,s.alumni,s.nisn , k.kelas, s.alamatsiswa
    												FROM siswa as s 
                                                    left join kelas k on s.idkelas = k.id
                                                    left join tahunajaran t on t.id = k.idtahunajaran
                                                    where s.alumni=0 AND s.create_by = '$_SESSION[id_user]' ORDER BY nis DESC";
												} else {
													$query = "SELECT nis,nama,asalsekolah,tmplahir,tgllahir,DAY(tgllahir) as tgl,MONTH(tgllahir) as bln,YEAR(tgllahir) as thn,s.id,s.statusmutasi,s.alumni,s.nisn , k.kelas, s.alamatsiswa
												FROM siswa as s 
                                                left join kelas k on s.idkelas = k.id
                                                left join tahunajaran t on t.id = k.idtahunajaran
                                                where s.alumni=0 ORDER BY nis DESC";
												}
												...
												?>
													<tr class="">
														...
														<td><?php echo $m['alamatsiswa'] ?></td>
														<?php if ($_SESSION['level'] == 'admin' or $_SESSION['level'] == 'absensi sp' or $_SESSION['level'] == 'absensi ibt' or $_SESSION['level'] == 'absensi ts' or $_SESSION['level'] == 'absensi aly' or $_SESSION['level'] == 'absensi sorogan' or $_SESSION['level'] == 'pendaftaran') {
															$sqla = "SELECT * FROM `siswa_nonaktif` WHERE `nis` = '$m[nis]'";
															$qakt = mysqli_query($conn, $sqla);
															if (mysqli_num_rows($qakt) > 0) {
																$akt = mysqli_fetch_assoc($qakt);
														?>
																<td align="center">
																	<a href="<?php echo $aksi ?>?mod=siswa&act=aktif&nis=<?php echo $m['nis'] ?>"><button class="btn btn-warning btn-sm"><i class="fa fa-check-circle"></i> Aktifkan</button> </a>
																</td>
															<?php
															} else {
															?>
																<td align="center">
																	<a href="<?php echo $aksi ?>?mod=siswa&act=nonaktif&nis=<?php echo $m['nis'] ?>"><button class="btn btn-danger btn-sm"><i class="fa fa-times-circle"></i> Non-Aktifkan</button> </a>
																</td>
															<?php
															}
															?>
														...
														<?php if ($_SESSION['level'] == 'absensi ibt' or $_SESSION['level'] == 'absensi ts' or $_SESSION['level'] == 'absensi sp' or $_SESSION['level'] == 'absensi aly') { ?>
															<td align="center">
		                                   ...
		                                   -->
																...
																<a href="<?php echo $linkaksi ?>&act=detail&id=<?php echo $m['id'] ?>"><button class="btn btn-info btn-sm"><i class="fa fa-search"></i></button> </a>
		                                   ...
		                                   -->
														...
														<?php
														} elseif ($_SESSION['level'] == 'keuangan madrasah' or $_SESSION['level'] == 'pendaftaran') {
														?>
															<td align="center">
																<?php
																if ($m['kelas'] == NULL) {
																?>
																	<a href="#" data-toggle="modal" class="btn btn-danger btn-sm" data-target="#mdlbaruedit<?php echo $m['id']; ?>">
																		...
																		<div class="modal-dialog">
																			<div class="modal-content">
																				<div class="modal-header">
																					...
																					<h4 class="modal-title">Pembayaran Santri Baru <?php echo $m['nis'] ?></h4>
																				</div>
																				<div class="modal-body">

																					<form class="form-horizontal" role="form" method='POST' action="<?php echo $aksi ?>?mod=siswa&act=kelas">
																						<input type="hidden" class="form-control round-input" name="nis" value="<?php echo $m['nis'] ?>">
																						<input type="hidden" class="form-control round-input" name="nama" value="<?php echo $m['nama'] ?>">
																						<div class="form-group">
																							<label class="col-lg-2 col-sm-2 control-label">KELAS</label>
																							<div class="col-lg-10">
																								<select name="idkelas" class="select2" style="width: 100%">
																						...
																						WHERE c.aktif = 'Aktif'");
																									while ($k = mysqli_fetch_assoc($sql_penilaian)) {
																										$sisa = $k['kapasitas'] - $k['tersisa'];
																										echo "<option value='$k[id]'>$k[kelas] : Sisa Bangku $sisa </option>";
																									}
																									?>
																								</select>
																							</div>
			...
			case 'detail':
				if (isset($_GET['id'])) {
					$sqltrans = mysqli_query($conn, "SELECT c.nis, c.nama, c.panggilan, c.tahunmasuk, c.idkelas, g.agama, b.status, a.kondisi, c.kelamin,
              ...
              LEFT JOIN agama AS g ON c.agama = g.id 
			 WHERE c.id='$_GET[id]'") or die(mysqli_error());
								...
								<div class="panel-body profile-information">
									<div class="col-md-3">
										<div class="profile-pic text-center">
											...
											if ($tra['foto'] == NULL) {
											?>
												<img src="images/siswa/santri.png" alt="" />
											<?php
											} else {
											?>
										...
										<th>ID Angkatan</th>
											...
											foreach ($sheet as $row) { // Lakukan perulangan dari data yang ada di excel
												...
												if ($numrow > 1) {
													...
													$ortu_td = (!empty($ortu)) ? "" : " style='background: #E07171;'";
													$kerja_td = (!empty($kerja)) ? "" : " style='background: #E07171;'";
													$hobi_td = (!empty($hobi)) ? "" : " style='background: #E07171;'";
													$idangkatan_td = (!empty($idangkatan)) ? "" : " style='background: #E07171;'";

													// Jika salah satu data ada yang kosong
													if ($nis == "" or $nama == "" or $panggilan == "" or $tahunajaran == "" or $jeniskelamin == "" or $tmplahir == "" or $tgllahir == "" or $hp == "" or $alamat == "" or $email == "" or $asal == "" or $idkelas == "" or $ortu == "" or $kerja == "" or $hobi == "" or $idangkatan == "") {
													...
													echo "<td" . $kerja_td . ">" . $kerja . "</td>";
													echo "<td" . $hobi_td . ">" . $hobi . "</td>";
													echo "<td" . $idangkatan_td . ">" . $idangkatan . "</td>";
													echo "</tr>";
													echo "</tbody>";
												}
