<?php
	...
	if($_SESSION['level']=='admin' OR $_SESSION['level']=='superadmin'){
	    ...
	    $linkaksi = 'med2.php?mod=naikkelas';
	}
                                ...
                                <div class="adv-table editable-table ">
		                            ...
		                            <table class="table table-striped table-hover table-bordered">
										...
										else
										{
											?>
											<tr>
												<td colspan="5" align="center"><i>Tidak Ada Yang Pindah Kelas</i></td>
											</tr>
											<?php
										}
										?>
			                        ...
			                        <div class="position-center">
		                                ...
		                                <div class="form-group">
		                                  <label class="col-lg-2 col-sm-2 control-label">Ke Kelas</label>
		                                  	<div class="col-lg-6">
		                                      	<select  id="e1" class="populate" name="kelas2" class="form-control round-input" style="width: 100%">
		                                          <?php
