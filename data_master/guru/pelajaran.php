	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				...
				$query = mysqli_query($conn,"SELECT a.`id`, a.`kode`, a.`nama`, a.`kkm`, a.`sifat`, a.`tingkat`, b.`kode` as kelompok, b.`keterangan` 
														FROM `pelajaran` as a
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" name="kkm" class="form-control round-input" value="<?php echo isset($c['kkm']) ? $c['kkm'] : '' ;?>" >
				                                </div>
				                            </div>
				                            <div class="form-group">
				                                <label class="col-lg-2 col-sm-2 control-label">Kelompok</label>
				                                <div class="col-lg-10">
				                                    <select class="form-control round-input" name="sifat" id="source">
				                                    	<?php
		                    ...
		                    <div class="panel-body">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT a.`id`, a.`kode`, a.`nama`, a.`kkm`, a.`tingkat`, a.`sifat`, b.`kode` as kelompok, b.`keterangan` 
														FROM `pelajaran` as a
