				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            	...
				                            	<div class="form-group">
			                                      ...
			                                      <div class="col-lg-10">
			                                          <select name="tingkat" class="form-control round-input" style="width: 100%">
				                            	...
				                            	<div class="form-group">
			                                      ...
			                                      <div class="col-lg-10">
			                                          <select name="idtahunajaran" class="form-control round-input" style="width: 100%">
			                                              <?php
		                    ...
		                    <div class="panel-body">
		                        ...
		                        <div class="adv-table editable-table ">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT a.`id`, a.`tingkat`, a.`kelas`, c.`tahunajaran` ,a.`idtahunajaran`, a.`kapasitas`,(SELECT COUNT(*) FROM `siswa` as d where d.`idkelas` = a.`id` and d.alumni='0' ) AS tersisa,(SELECT COUNT(*) FROM `siswa` as d LEFT JOIN `siswa_nonaktif` as ak ON d.`nis` = ak.`nis` where ak.`nis` IS NULL AND d.`idkelas` = a.`id` and d.alumni='0' ) as aktif, a.`nipwali`,b.`nama`, a.`keterangan` 
												FROM `kelas` as a
...
";
											...
											while ($m = mysqli_fetch_assoc($sql_kul)) {
											    $sqla = "SELECT * FROM `siswa_nonaktif` WHERE `` = '$m[nis]'";
												$qakt = mysqli_query($conn, $sqla);
												$jma = mysqli_num_rows($qakt);
										?>
		                                <tr class="">
		                                   ...
		                                   --> 
		                                        <a href="med.php?mod=kelas&act=detail&id=<?php echo $m['id'] ?>" ><button class="btn btn-info btn-sm"><i class="fa fa-search"></i></button> </a>
		                        ...
		                        <div class="adv-table editable-table ">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <?php
                                                ...
                                                where s.alumni=0 AND  k.id='$_GET[id]' ORDER BY nis DESC";
		                                ...
		                                <tr class="">
		                                    ...
		                                    <?php
												...
												?>												
												<td align="center">
													<button class="btn btn-danger btn-sm"><i class="fa fa-times-circle"></i> Tidak Aktif</button>
												</td>
												<?php
												}else{
												?>												
												<td align="center">
													<button class="btn btn-warning btn-sm"><i class="fa fa-check-circle"></i> Aktif</button>
												</td>
												<?php
												}
											?>
