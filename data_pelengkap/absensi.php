<?php
	...
	if(isset($_SESSION['absensi']) AND $_SESSION['absensi'] <> 'TRUE')
	{
		?>
	...
	$aksi = 'mod/data_pelengkap/act_absensi.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				...
				$query = mysqli_query($conn,"SELECT * FROM absensi WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=absensi");
				}
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=absensi&act=form">
		                    ...
		                    <div class="panel-body">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT * FROM absensi order by urutan asc";
		                                ...
		                                <tr class="">
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=absensi&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=absensi&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
