<?php
	...
	if(isset($_SESSION['pekerjaan']) AND $_SESSION['pekerjaan'] <> 'TRUE')
	{
		?>
	...
	//link buat paging
	$linkaksi = 'med.php?mod=pekerjaan';
	...
	$aksi = 'mod/data_pelengkap/act_pekerjaan.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=pekerjaan&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM jenispekerjaan WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=pekerjaan");
				}

			}
			else
			{
				$act = "$aksi?mod=pekerjaan&act=simpan";
			}
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" name="pekerjaan" class="form-control round-input" value="<?php echo isset($c['pekerjaan']) ? $c['pekerjaan'] : '' ;?>" required>
				                                </div>
				                            </div>
				                            <div class="form-group">
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=pekerjaan&act=form">
		                    ...
		                    <div class="panel-body">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT * FROM jenispekerjaan order by urutan asc";
		                                ...
		                                <tr class="">
		                                    ...
		                                    <td align="center"><?php echo $m['pekerjaan']?></td>
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=pekerjaan&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=pekerjaan&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
