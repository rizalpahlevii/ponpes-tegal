<?php
	...
	if(isset($_SESSION['statusiswa']) AND $_SESSION['statusiswa'] <> 'TRUE')
	{
		?>
	...
	//link buat paging
	$linkaksi = 'med.php?mod=statusiswa';
	...
	$aksi = 'mod/data_pelengkap/act_statusiswa.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=statusiswa&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM statussiswa WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=statusiswa");
				}

			}
			else
			{
				$act = "$aksi?mod=statusiswa&act=simpan";
			}
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" name="status" class="form-control round-input" value="<?php echo isset($c['status']) ? $c['status'] : '' ;?>" required>
				                                </div>
				                            </div>
				                            <div class="form-group">
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=statusiswa&act=form">
		                    ...
		                    <div class="panel-body">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT * FROM statussiswa order by urutan asc";
		                                ...
		                                <tr class="">
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=statusiswa&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=statusiswa&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
