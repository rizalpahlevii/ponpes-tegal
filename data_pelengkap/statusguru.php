<?php
	...
	if(isset($_SESSION['statusguru']) AND $_SESSION['statusguru'] <> 'TRUE')
	{
		?>
	...
	//link buat paging
	$linkaksi = 'med.php?mod=statusguru';
	...
	$aksi = 'mod/data_pelengkap/act_statusguru.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=statusguru&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM statusguru WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=statusguru");
				}

			}
			else
			{
				$act = "$aksi?mod=statusguru&act=simpan";
			}
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=statusguru&act=form">
		                        ...
		                        <div class="adv-table editable-table table-responsive">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tr class="">
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=statusguru&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=statusguru&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
