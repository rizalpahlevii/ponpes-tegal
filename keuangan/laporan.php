		                                ...
		                                <tr class="">										
											<?php
												...
												while($month1 <= $end1)											
												{
													$bln1 = date('m', $month1);	
													$thn1 = date('Y', $month1);	
												$qbln = mysqli_query($conn,"SELECT `id`, `nis`, `idtahunajaran`, `bulanke`, `nominal`, `potongan`, DAY(date) AS tanggal, MONTH(date) AS bulan, YEAR(date) AS tahun FROM `spp` WHERE `nis` = '$tra[nis]' AND `idtahunajaran` = '$tra[idtahunajaran]' AND `bulanke` = '$bln1' ");				
			        ...
			        <!-- page start-->
				        ...
				        <div class="row">
				            <div class="col-sm-12">
				                <section class="panel">
				                    <header class="panel-heading">
				                        DATA LAPORAN PEMBAYARAN SPP MADRASAH
				                        <span class="tools pull-right">
				                            <a href="javascript:;" class="fa fa-chevron-down"></a>
				                            <a href="javascript:;" class="fa fa-cog"></a>
				                            <a href="javascript:;" class="fa fa-times"></a>
				                    ...
				                    <div class="panel-body table-responsive">
		                                ...
		                                <tr>
											...
											<?php
											$query = "SELECT DISTINCT `bulanke` FROM `spp` WHERE `idtahunajaran` = '$_POST[idtahunajaran]' order by `date`";
		                                ...
		                                <tr class="">										
											...
											while ($m = mysqli_fetch_assoc($sql_kul)) {
											$blnk = $m['bulanke'];
											$qbln = mysqli_query($conn,"SELECT `id`, `nis`, `idtahunajaran`, `bulanke`, `nominal`,`potongan`, DAY(date) AS tanggal, MONTH(date) AS bulan, YEAR(date) AS tahun FROM `spp` WHERE `nis` = '$n[nis]' AND `idtahunajaran` = '$n[idtahunajaran]' AND `bulanke` = '$blnk' ");				
											$bln = mysqli_fetch_assoc($qbln);				
											?>
											...
											<td align="center" style="vertical-align : middle;text-align:center;">
												<table class="table table-bordered">													
													...
													<tr>
														<td class="bg-success" align="center"><?php echo $bln['tanggal']?> <?php echo NamaBulan($bln['bulan'])?> <?php echo $bln['tahun']?></td>
													</tr>
													<?php
													}else{
													?>
                                                              ...
                                                              <label class="col-lg-2 col-sm-2 control-label">Tahun</label>
                                                              	<div class="col-lg-10">
                                                                  	<select  class="populate e1p" name="tahun"  style="width: 100%">
                                                                        <?php
                            	                                            $sql_angkatan = mysqli_query($conn,"SELECT DISTINCT YEAR(`date`) AS tahun FROM `spp` ORDER BY `date` DESC");
                            	                                            while($k = mysqli_fetch_assoc($sql_angkatan))
                            	                                            {
			...
			?>
		        ...
		        <div class="row">
		            ...
		            <div class="col-sm-12">
		                <section class="panel">
		                    <header class="panel-heading">
		                        Data Laporan Madrasah Bulan <?php echo getBulanHijriah($bln) ?> 
		                        <span class="tools pull-right">
		                            <a href="javascript:;" class="fa fa-chevron-down"></a>
		                            <a href="javascript:;" class="fa fa-cog"></a>
		                            <a href="javascript:;" class="fa fa-times"></a>
			...
			?>
		        ...
		        <div class="row">
		            ...
		            <div class="col-sm-12">
		                <section class="panel">
		                    <header class="panel-heading">
		                        Data Laporan Madrasah Tahun <?php echo $tahun ?> 
		                        <span class="tools pull-right">
		                            <a href="javascript:;" class="fa fa-chevron-down"></a>
		                            <a href="javascript:;" class="fa fa-cog"></a>
		                            <a href="javascript:;" class="fa fa-times"></a>
