		...
		if(!empty($_GET['id']))
			{
				...
				else
				{
					if($_SESSION['level']=='keuangan'){
						...
						header("location:med.php?mod=spp");
					}
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input name="tgl" class="form-control form-control-inline input-medium default-date-picker  round-input"  size="16" type="text" value="<?php echo isset($c['date']) ? $c['date'] : $tgl ;?>" />
				                                </div>
				                            </div>
				                            
				                            <?php
				                             $sqlamb = mysqli_query($conn,"SELECT k.*
														FROM siswa as s 
											            left join kelas k on s.idkelas = k.id
											            left join tahunajaran t on t.id = k.idtahunajaran
										                WHERE s.`nis` = '$nis' AND t.`id` = '$thn'");
										    $abl = mysqli_fetch_assoc($sqlamb);
										    if ($abl['tingkat'] >= 3 && $abl['tingkat'] <= 6) {
										    	$bayar = "65000";
										    }else{
										    	$bayar = "70000";
										    }
			                                ...
			                                <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" id="harga" name="nominal" class="form-control round-input currency4" value="<?php echo isset($c['nominal']) ? $c['nominal'] : $bayar ;?>" required>
				                                </div>
				                            </div>
				                            <div class="form-group">
				                            ...
				                            <!--<input type="hidden" name="nominal" value="<?php echo $bayar ?>">	  -->                          
				            ...
				            <div class="col-sm-12">
				                <section class="panel">
				                    ...
				                    <div class="panel-body table-responsive">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT `id`, `nis`, `idtahunajaran`, `bulanke`, `nominal`, `potongan`, DAY(date) AS tanggal, MONTH(date) AS bulan, YEAR(date) AS tahun FROM `spp` WHERE `nis` = '$tra[nis]' AND `idtahunajaran` = '$tra[idtahunajaran]' order by `bulanke`";
		                                ...
		                                <tr class="">
		                                   ...
		                                   --> 
		                                        <a target="_blank" href="popup/popup.php?mod=spp&id=<?php echo $m['id'] ?>" ><button class="btn btn-warning btn-sm"><i class="fa fa-print"></i></button> </a>
