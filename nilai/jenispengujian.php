<?php
	...
	if(isset($_SESSION['jenispengujian']) AND $_SESSION['jenispengujian'] <> 'TRUE')
	{
		?>
	...
	//link buat paging
	$linkaksi = 'med.php?mod=jenispengujian';
	...
	$aksi = 'mod/nilai/act_jenispengujian.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=jenispengujian&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM jenisujian WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=jenispengujian");
				}

			}
			else
			{
				$act = "$aksi?mod=jenispengujian&act=simpan";
			}
				                ...
				                <section class="panel">
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Jenis Pengujian</label>
				                                <div class="col-lg-10">
				                                    <input type="text" name="jenisujian" class="form-control round-input" value="<?php echo isset($c['jenisujian']) ? $c['jenisujian'] : '' ;?>" required>
				                                </div>
				                            </div>
				                            <div class="form-group">
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=jenispengujian&act=form">
		                    ...
		                    <div class="panel-body table-responsive">
		                        ...
		                        <div class="adv-table editable-table ">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT a.`id`, a.`kode`, a.`jenisujian`, b.`kode` as kd, b.`nama`, a.`keterangan` 
														FROM `jenisujian` as a
		                                ...
		                                <tr class="">
		                                    ...
		                                    <td width="" align="center"><?php echo $m['kode']?></td>
		                                    <td align="center"><?php echo $m['kode']?> - <?php echo $m['nama']?></td>
		                                    <td align="center"><?php echo $m['jenisujian']?></td>
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=jenispengujian&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=jenispengujian&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
