	...
	default:
			        ...
			        <div class="panel-body profile-information">
			           ...
			           <div class="col-md-9 table-responsive">
			               <div class="profile-desk">
			               	<div class="tab-pane ">                
				                <div class="prf-contacts sttng">
				                    <h2>DATA NILAI RAPORT <?php echo $kls['tahunajaran'] ?></h2>
				                </div>      
				            </div>
			               	<table class="table table-borderless" >
			               		<tr>
		...
		<?php
			...
			<section class="panel">
			    <div class="panel-body">
			            <?php
            	    	if ($_SESSION['level']=='admin' or $_SESSION['level']=='superadmin' OR $_SESSION['level']=='absensi sp' OR $_SESSION['level']=='nilai ibt' OR $_SESSION['level']=='nilai ts' OR $_SESSION['level']=='nilai aly' OR $_SESSION['level']=='absensi ibt' OR $_SESSION['level']=='absensi ts' OR $_SESSION['level']=='absensi aly') {
            	    	?>
			            <div class="btn-group">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                <li><a target="_blank" href="popup/popup.php?mod=raport_siswa&idkelas=<?php echo $idkelas ?>&idsemester=<?php echo $idsemester ?>&nis=<?php echo $nis ?>">PDF</a></li>
                                <li><a href="popup/raport_siswa_excel.php?idkelas=<?php echo $idkelas ?>&idsemester=<?php echo $idsemester ?>&nis=<?php echo $nis ?>">Excel</a></li>
                            </ul>
                        </div><!-- /btn-group -->
                        <br><br>
                        <?php	
			        ...
			        <section id="flip-scroll">
			        	<div class="table-responsive" >
			        	 <table class="table table-bordered nowrap" id="exampleres">
			        	 	<thead>
			        	 		<tr>
			        	 			<th class="text-center">No</th>
			        	 	...
			        	 	<tbody>
							    ...
							    ?>
							    <tr>
							        <td class="bg-success" colspan="6" align="center"><?php echo $k['keterangan'] ?></td>
							    </tr>
