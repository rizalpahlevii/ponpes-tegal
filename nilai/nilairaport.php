										...
										<div class="panel-body">
										    <div class="btn-group">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    <li><a target="_blank" href="popup/popup.php?mod=raport_kelas&idkelas=<?php echo $idkelas ?>&idsemester=<?php echo $idsemester ?>">PDF</a></li>
                                                    <li><a href="popup/raport_kelas_excel.php?idkelas=<?php echo $idkelas ?>&idsemester=<?php echo $idsemester ?>">Excel</a></li>
                                                </ul>
                                            </div><!-- /btn-group -->
									        <section id="flip-scroll">
									        	<div class="table-responsive" style="overflow-x:auto;">
							                        <div class="adv-table editable-table">
							                            ...
							                            <table class="table table-striped table-hover table-bordered nowrap" id="examplea">
							                                <thead>
							                                <tr>
