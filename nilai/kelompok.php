<?php
	...
	if(isset($_SESSION['kelompok']) AND $_SESSION['kelompok'] <> 'TRUE')
	{
		?>
	...
	$aksi = 'mod/nilai/act_kelompok.php';
	...
	switch ($act) {
		case 'form':
			if(!empty($_GET['id']))
			{
				$act = "$aksi?mod=kelompok&act=edit";
				$query = mysqli_query($conn,"SELECT * FROM aspekkelompok WHERE id = '$_GET[id]'");
				...
				{
					header("location:med.php?mod=kelompok");
				}

			}
			else
			{
				$act = "$aksi?mod=kelompok&act=simpan";
			}
				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-10">
				                                    <input type="text" name="aspekkelompok" class="form-control round-input" value="<?php echo isset($c['kode']) ? $c['kode'] : '' ;?>" required>
				                                </div>
				                            </div>
				                            <div class="form-group">
				                                <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Aspek Kelompok</label>
				                                <div class="col-lg-10">
		                ...
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin'){?>
		                        	<a href="med.php?mod=kelompok&act=form">
		                        ...
		                        <div class="adv-table editable-table ">
		                            ...
		                            <table class="table table-striped table-hover table-bordered" id="example">
		                                ...
		                                <tr>
											...
											<th class="text-center">Aspek Kelompok</th>
											<?php if($_SESSION['level']=='admin' ){?>
		                                ...
		                                <tbody>
		                                <?php
											$query = "SELECT * FROM aspekkelompok ORDER BY posisi";
		                                ...
		                                <tr class="">
		                                   ...
		                                   --> <?php if($_SESSION['level']=='admin' ){?>
		                                        <a href="med.php?mod=kelompok&act=form&id=<?php echo $m['id'] ?>" ><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
												<a href="<?php echo $aksi ?>?mod=kelompok&act=hapus&id=<?php echo $m['id'] ?>" onclick="return myFunction();"><button class="btn btn-danger btn-sm"><i class="fa fa-times"></i></button> </a>
