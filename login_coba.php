...
.wrapper {
  background: #4aa71b;
  background: -webkit-linear-gradient(top left, #4aa71b 0%, #53e3a6 100%);
  background: linear-gradient(to bottom right, #4aa71b 0%, #53e3a6 100%);
  position: absolute;
  left: 0;
  width: 100%;
  height: 100%;
...
<div class="wrapper">
	<div class="container">
        <!--<h2 class="form-signin-heading"><img src="images/logo.png" alt=""></h2>-->
        <h2 class="form-signin-heading"><img src="assets/login/logo.png" height="50px" alt=""></h2>
