				                    ...
				                    <div class="panel-body">
				                        <div class="position-center">
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-6">
				                                    <select  name="sumber" class="form-control round-input" style="width: 100%">
		                                              <?php
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-6">
				                                    <select  name="kategori" class="form-control round-input" style="width: 100%">
		                                              <?php
				                            ...
				                            <div class="form-group">
				                                ...
				                                <div class="col-lg-6">
				                                    <select  name="rak" class="form-control round-input" style="width: 100%">
		                                              <?php
			...
			?>
		        ...
		        <div class="row">
		            ...
		            <div class="col-sm-12">
		                <section class="panel">
		                    <header class="panel-heading">
		                        <?php if($_SESSION['level']=='admin' OR $_SESSION['level']=='perpustakaan'){?>
